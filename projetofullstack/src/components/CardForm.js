...
const CardForm = ({ onSubmit, onClose }) => {
  ...
  return (
    <form onSubmit={handleSubmit} style={{display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <Title style={{fontSize: '30px'}}>Digite os dados para salvar o card</Title>
      <label>
      ...
      <Button type='submit' variant="contained" style={{ marginTop:'20px', backgroundColor: '#ADFF2F', color: 'black', width: '10rem' }}
      >Salvar</Button>
    </form>
  );
};
